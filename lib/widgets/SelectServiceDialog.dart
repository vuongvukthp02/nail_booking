...
class SelectServiceDialog extends StatefulWidget {
  ...
  SelectServiceDialog(
      {this.title = '', required this.callback, required this.id_parent});
            ...
            children: <Widget>[
              GestureDetector(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'Choose service for ${widget.title}',
                      style: boldTextStyle(
                          color: appStore.textPrimaryColor, size: 15),
                      softWrap: true,
                    ).expand(),
                    // Container(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Row(
                            children: [
                              Text(
                                itemsService[index]['Service'],
                                softWrap: true,
                              ).expand(),
                              Text("From £${itemsService[index]['Price']}"),
                            ],
                          ),
                        ).expand(),
                      ],
